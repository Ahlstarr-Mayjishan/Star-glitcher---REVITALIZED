...
local TrackerInvalidationPolicy = requireModule("Modules/Utils/TrackerInvalidationPolicy.lua")
...
local tracker = Tracker.new(Config, detector, taskScheduler, TargetClassifier, TrackerInvalidationPolicy)
