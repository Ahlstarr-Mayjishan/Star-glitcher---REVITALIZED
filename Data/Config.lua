...
Config.Prediction = {
    ...
    POSITION_CHANGE_EPSILON = 0.01,
    VELOCITY_HOLD_DECAY_START = 0.055,
    VELOCITY_HOLD_MAX = 0.12,
    MAX_OBSERVATION_EXTRAPOLATION = 0.1,
    OBSERVATION_COMPENSATION_SCALE = 0.9,
    STABILIZER_BASE_RESPONSE = 26,
    STABILIZER_CATCHUP_RESPONSE = 96,
    STABILIZER_CATCHUP_DISTANCE = 8,
    STABILIZER_EMERGENCY_SNAP_DISTANCE = 48,
    TELEPORT_MEMORY = 0.9,
